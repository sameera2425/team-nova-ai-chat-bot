...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-56 bg-blue-50 border-r border-blue-100 p-4 flex flex-col">
        {/* Logo */}
        <div className="mb-6 flex items-center gap-2">
          ...
          />
          <div>
            <h1 className="text-xl font-bold text-blue-900 mb-1">Teslearn</h1>
            <p className="text-xs text-blue-600 font-medium">Learn Your Way.</p>
          </div>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="w-full pl-10 pr-4 py-2 bg-white rounded-xl border border-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent transition-all duration-200 text-sm"
          />
        </div>
      ...
      <div className="flex-1 p-6 overflow-auto">
        ...
        <div className="mb-4">
          ...
          {/* AI Assistant Visual - Increased size */}
        ...
        {/* Container for cards and prompt box - Aligned */}
        <div className="max-w-4xl mx-auto">
          {/* Feature Cards - Aligned with prompt box */}
...
const NavItem = ({ icon: Icon, text, active = false }) => (
  <button
    className={`w-full flex items-center gap-2 px-3 py-2 rounded-xl transition-all duration-200 hover-scale text-sm ${
      active
